import { BidType, EngagementType, LeadSource, LeadStatus } from "./types";
...
export const STATUSES: LeadStatus[] = ['Submitted', 'Viewed', 'Discussion', 'Follow Up', 'Waiting Client', 'Won', 'Lost'] as const;