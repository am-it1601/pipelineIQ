...
import ErrorState from "@/blocks/shared/ErrorState";
...
import { RefreshCw, Trash2, Clock, Mail } from "lucide-react";
  ...
  return (
    <Card className="shadow">
      <CardHeader>
        ...
        <CardDescription>
          Track sent invitations, review assigned roles or groups, and manage
      ...
      <CardContent className="space-y-2">
        ...
        {/* Error */}
        {error && (
          <ErrorState message={error?.message ?? "Failed to load invitations"} />
        )}
