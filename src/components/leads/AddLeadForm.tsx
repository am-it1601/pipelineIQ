...
const AddLeadForm = forwardRef<LeadFormHandle, AddLeadFormProps>((props, ref) => {
  const { form, engagement_type, lead_source, computedLeadBudget } = useLeadForm();
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetContent className="min-w-1/3 p-4">
        <SheetHeader>
          <SheetTitle className="text-lg font-semibold flex justify-center items-center gap-2">
        ...
        >
          <FieldSet className="w-full gap-4 ">
            <FieldGroup className="w-full grid grid-cols-2 ">
              <Controller
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <FieldSet data-invalid={fieldState.invalid} className="w-full">
                        ...
                        <FieldDescription className="field_description">
                          Indicates whether the lead was submitted as a regular proposal or a
                          boosted proposal on Upwork.
                        </FieldDescription>
                        <RadioGroup
                          name={field.name}
                          value={field.value}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid} className="w-full">
                    ...
                    <FieldDescription className="field_description">
                      Additional notes or comments about the lead, such as specific client
                      requirements, communication details, or follow-up actions.
                    </FieldDescription>
                    {fieldState.error && (
                      <FieldError className="text-xs text-right font-semibold">
                        {fieldState.error.message}
        ...
        <SheetFooter className="border-t border-primary">
          <div className="grid grid-cols-3 gap-4">
            ...
            {/* <Button type="button" size='lg' variant='outline'
                        disabled={!leadFormRef.current?.isDirty() || !leadFormRef.current?.isValid()} onClick={handleSaveAndNew}>
                            <PlusIcon className='h-5 w-5 mr-2' />
                            Save & New
                        </Button>
                        <Button type="button" size='lg' variant='destructive' onClick={handleCloseWithoutSaving}>
                            <PlusIcon className='h-5 w-5 mr-2' />
