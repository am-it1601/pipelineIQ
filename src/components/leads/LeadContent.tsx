    ...
    return (
        <div className="flex flex-col gap-2 py-2">
            <Card>
                <CardHeader>
                    <CardAction>
                        <Button variant="outline" size="sm" onClick={() => addLeadFormRef.current?.toggleSheet()}>
            ...
            <Card>
                <CardContent className="flex flex-col gap-4 overflow-y-auto">
                    {/* Filters */}
                    <Collapsible open={showFilters} onOpenChange={setShowFilters} className="flex flex-col gap-2">
