...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        router.refresh(); // Refresh to pick up new session in proxy
    };
    ...
    return (
        <div style={{ display: "flex", minHeight: "100vh", background: "var(--background)" }}>
            ...
            <div
                className="login-left-pane base-1/2"
                style={{
                    position: "relative",
                    overflow: "hidden",
            ...
            >
                ...
                <div style={{ position: "relative", zIndex: 10, maxWidth: 480 }} className="base-1/3">
                ...
                >
                    ...
                    <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                        ...
                        <button
                            ...
                            onMouseDown={(e) => {
                                if (!loading && email && password) e.currentTarget.style.transform = "translateY(1px)";
                                e.currentTarget.style.boxShadow = "none";
                            }}
                            onMouseUp={(e) => {
