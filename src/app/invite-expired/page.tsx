      ...
      <div className="w-full max-w-md animate-fade-in text-center">
        ...
        <Card className="border-destructive/20">
          <CardContent className="pt-8 pb-8">
            ...
            <h1 className="mb-2 text-xl font-bold tracking-tight">Invitation Link Expired</h1>
            ...
            <p className="mt-6 text-xs text-muted-foreground">
              If you believe this is an error, please reach out to your team admin to have the
              invitation re-sent.
            </p>
          </CardContent>
        </Card>
