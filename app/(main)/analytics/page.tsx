...
export default function AnalyticsPage() {
  ...
  return (
    <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ ...cardStyle, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          <div>
            ...
            <div
              style={{
                fontSize: 11,
                color: mom.bidsDelta >= 0 ? "#10b981" : "#ef4444",
                fontWeight: 600,
              }}
            >
      ...
      <div style={cardStyle}>
        <SectionHeader
          title="BD Member Comparison"
          subtitle="Total bids, wins, and pipeline by member"
        />
      ...
      <div style={cardStyle}>
        <SectionHeader
          title="Profile Performance Comparison"
          subtitle="Bids, wins, and boost analysis by Upwork profile"
        />
              ...
              {sources.map((s, i) => (
                ...
                >
                  ...
                  <td
                    style={{
                      padding: "8px 10px",
                      color: s.winRate >= 0.15 ? "#10b981" : "#f59e0b",
                      fontWeight: 600,
                    }}
                  >
                  ...
                  <td style={{ padding: "8px 10px" }}>
                    ...
                    >
                      <div
                        style={{
                          height: "100%",
                          width: `${leads.length > 0 ? (s.total / leads.length) * 100 : 0}%`,
                          background: COLORS[i],
                          borderRadius: 3,
                        }}
                      />
        ...
        <div style={cardStyle}>
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: 32, fontWeight: 700, color: "var(--text)", marginTop: 6 }}>
